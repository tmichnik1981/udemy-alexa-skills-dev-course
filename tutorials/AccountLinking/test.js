...
var usrId = 'testUsr';
var token = "ya29.GlxFBTHpDTbSK-KTBu_rExhMqfXvkd3uKEAz03fFTgqENeJ4NaUgd23wQh7fG5Ffm92OK72p_k4rFnsWtPJl9KoqrmZzuZX4BfXL4M0EE_xvlm0kkxxHBLPJwDkVvA";
...
var event = {
  session: {
    ...
    application: {
      applicationId: 'amzn1.ask.skill.d1dbcf35-374e-42c5-9e88-0ccd3923c126'
...
describe(`Test EmailAuthIntent correct pin`, function() {
 ...
 it('valid outputSpeech', function() {
   expect(ctx.speechResponse.response.outputSpeech.ssml).to.match(new RegExp(`You have total`));
 });
